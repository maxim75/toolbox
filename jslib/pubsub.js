(function (scope) {
    ...
    if (typeof window === 'object') {
        ...
        window.pubsubOpenSandbox = function () { window.originalPubSub = window.pubsub; window.pubsub = new Pubsub(pubsubConfig); };
        window.pubsubCloseSandbox = function () { window.pubsub = window.originalPubSub; window.originalPubSub = null; };
        if (window !== scope) {
